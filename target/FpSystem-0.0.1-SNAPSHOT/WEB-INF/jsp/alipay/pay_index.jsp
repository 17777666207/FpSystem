...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/style/css/alipay.css">
...
<div id="main">
    <div class="return_pay">
        <%--        <a  href="${pageContext.request.contextPath }/admin/show_particulars.do?id=${order.article_id}">返回</a>--%>

        <div class="border_left_p"></div>
        <div class="return_article">
            <a href="${pageContext.request.contextPath }/admin/show_particulars.do?id=${order.article_id}"><< 返回上一页</a>
        </div>
    </div>


    <div class="img_pay">
        <img src="${pageContext.request.contextPath}/style/imags/payment.png">
    </div>
    ...
    <div class="align_box">
        ...
        <div style="padding-left: 230px">
            <form name=alipayment action=alipay.trade.page.pay.do method=post
                  target="_blank">
                <div id="body1" class="show" name="divcontent">
                    <dl class="content">
                        ...
                        <dt>订单名称 ：</dt>
                        <dd>
                            <input id="WIDsubject" name="WIDsubject" type="text" value="${order.subject}"/>
                        </dd>
                        <hr class="one_line">
                        <dt>付款金额 ：</dt>
                        <dd>
                            <input id="WIDtotal_amount" name="WIDtotal_amount" placeholder="请输入您要帮助的金额"/>
                        </dd>
                        <hr class="one_line">
                        <dt>说点什么吧：</dt>
                        <dd>
                            <input id="WIDbody" name="WIDbody" placeholder="谢谢您!"/>
                        </dd>
                        <hr class="one_line">
                        <input name="h_id" type="hidden" value="${order.h_id}"/>
                        <input name="user_id" type="hidden" value="${order.user_id}"/>
                        <input name="user_account" type="hidden" value="${order.user_account}"/>
                        <input name="subject" type="hidden" value="${order.subject}"/>
                        <input name="article_id" type="hidden" value="${order.article_id}"/>
                        <input name="articleClass" type="hidden" value="${order.articleClass}"/>
                        <input name="pay_status" type="hidden" value="${order.pay_status}"/>
                        <input name="addTime" type="hidden" value="${order.addTime}"/>
                        <dt></dt>
                        <%--<dd id="btn-dd">
