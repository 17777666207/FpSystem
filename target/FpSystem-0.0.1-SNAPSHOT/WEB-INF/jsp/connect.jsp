...
<div class="article">
    ...
    <div class="article_box" style="width: 1350px;margin-left: -120px;">
        ...
        <div class="acc_title">
            <ul style="height: 50px;line-height: 50px;margin-left: 15px">
                <li style="float: left;font-size: 25px;">扶贫对接</li>
            </ul>
    ...
    <nav aria-label="Page navigation">
        <div id="pages" style="margin-left: 380px">

            <ul class="pagination">
                <li><a href="#" class="current_page">当前页码：${ac.pageNum} 总页数: ${ac.pages}  </a></li>
                <li><a href="${pageContext.request.contextPath}/admin/connect.do">首页</a></li>
                <c:if test="${ac.pageNum > 1}">
                    <li><a href="${pageContext.request.contextPath}/admin/connect.do?pageNum=${ac.prePage}">上一页</a></li>
                </c:if>
                <c:if test="${ac.pageNum != ac.pages}">
                    <li><a href="${pageContext.request.contextPath}/admin/connect.do?pageNum=${ac.nextPage}">下一页</a>
                    </li>
                </c:if>
                <li><a href="${pageContext.request.contextPath}/admin/connect.do?pageNum=${ac.pages}">尾页</a></li>
            </ul>
        </div>
    </nav>
</div>
